...
/*
        ...
        isim variable'inin degeri gorunsun ama degistilemesin
        satisTutari ise deger girilebilsin ama girilen degerler sonradan gorulemesin

        Eger bir variabla icin read veya write ozelliklerinin
        birbirinden ayrilmasi isteniyorsa
        oncelikle acces modifier ile kimsenin ulasamamasini saglayin
