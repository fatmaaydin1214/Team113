...
public class C05_HashMapMethodlari {
    public static void main(String[] args) {
        ...
        //verilen Key varsa valeu'sunu dondurur yoksa null dondurur
        System.out.println(ornekMap.getOrDefault("M", 60));//20
        System.out.println(ornekMap.getOrDefault("Z", 60));//60
        // verilen key varsa valusunu getirir, yoksa verilen default degeri dondurur
        ...
        //Verilen keyin eski valuesu verilen deger ise update edip true doner
        //keyin degeri verilen deger degilse bir islem yapmaz ve false dondurur
